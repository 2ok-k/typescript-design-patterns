/**
 * Appellé aussi Fabrique abstraite; il fournit une interface pour créer des objets
 * d'une même famille sans préciser leurs classes concrèts
 * 
 * Il permet d'isoler l'appartenance à une famille de classes
 */
